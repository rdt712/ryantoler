...
![sharpe](/static/images/sharpe-ratio/sharpe.jpeg)

He introduced the
[reward-to-variability ratio](https://web.stanford.edu/~wfsharpe/art/sr/sr.htm) in 1966 that soon
...
![output_5_1.png](/static/images/sharpe-ratio/output_5_1.png)
...
![output_7_1.png](/static/images/sharpe-ratio/output_7_1.png)
...
![output_9_1.png](/static/images/sharpe-ratio/output_9_1.png)

## Daily S&amp;P 500 returns

For the S&amp;P 500, calculating daily returns works just the same way, we just need to make sure
we select it as a `Series` using single brackets `[]` and not as a

`DataFrame` to facilitate the calculations in the next step.
...
![output_11_1.png](/static/images/sharpe-ratio/output_11_1.png)
...
is calculated as the difference in returns between `stock_returns` and

`sp_returns` for each day.
...
![output_13_1.png](/static/images/sharpe-ratio/output_13_1.png)
...
`excess_returns`. This tells us how much more or less the investment yields per day
...
![output_15_1.png](/static/images/sharpe-ratio/output_15_1.png)
...
Next, we calculate the standard deviation of the `excess_returns`. This shows us the
...
![output_17_1.png](/static/images/sharpe-ratio/output_17_1.png)

## Putting it all together

Now we just need to compute the ratio of `avg_excess_returns` and

`sd_excess_returns`. The result is now finally the _Sharpe ratio_ and indicates
how much more (or less) return the investment opportunity under consideration yields per unit of
risk.

The Sharpe Ratio is often _annualized_ by multiplying it by the square root of the number
...
![output_19_1.png](/static/images/sharpe-ratio/output_19_1.png)
